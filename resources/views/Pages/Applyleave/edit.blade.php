                ...
                <div class="card-body">
                    ...
                    <form action="{{url('update/applyleave/'.$data->id)}}" method="POST">
                        ...
                        <div class="form-group mb-3 visually-hidden">
                            ...
                            <input type="int" class="form-control @error('user_id') is-invalid @enderror" name="user_id" value="{{$data->user_id}}" required autocomplete="user_id" autofocus>
                        </div>
                        <!-- end -->
                        <!-- $leavetype start -->
                        ...
                        <div class="form-group mb-3 ">
                            ...
                            <textarea type="text" class="form-control @error('description') is-invalid @enderror" name="description" value="{{$data->description}}" placeholder="State the reason for Application!" required autofocus>{{$data->description}}</textarea>
                        </div>
