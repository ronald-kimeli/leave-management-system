            ...
            <div class="card-body">
                ...
                <form action="{{url('admin/add/user')}}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select class="form-control selectpicker @error('gender') is-invalid @enderror" name="gender" value="{{ old('gender') }}" required autocomplete="gender" autofocus>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="integer" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" required autocomplete="phone" autofocus>
                    </div>
