                        ...
                        <div class="nav">
                         ...
                         <!-- end -->
                            ...
                            <div class="collapse" id="collapse" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ url('admin/applyleave')}}">View Leave Type</a>
                                    </nav>
                            </div>
                            ...
                            <!-- Department -->
                            <a class="nav-link collapsed" href="{{ url('department')}}" data-bs-target="#collapseLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                                Department
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                           <!-- end department -->
